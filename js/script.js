...
let button_data_name = document.getElementById('save_data');
let button_data_distance = parseInt(document.getElementById('dave_data'));
let button_data_age = parseInt(document.getElementById('save_data'));
